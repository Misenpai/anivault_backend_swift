...
struct BatchOperationResponse: Content {
    ...
    init(message: String = "Batch operation completed",
         totalProcessed: Int,
         successful: Int,
         failed: Int,
         errors: [String]? = nil) {
...
struct ResponseBuilder {
    ...
    static func batch(totalProcessed: Int, successful: Int, failed: Int, errors: [String]? = nil) -> BatchOperationResponse {
    ...
    static func status(_ status: String, message: String? = nil, details: [String: String]? = nil) -> StatusResponse {
        return StatusResponse(status: status, message: message, details: details)
    }
}

extension Response {
    static func success<T: Content>(_ data: T, status: HTTPStatus = .ok, message: String? = nil) throws -> Response {
